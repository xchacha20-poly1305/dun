...
func createPreStartedClient() (*dunbox.Box, error) {
	options, err := readConfigAndMerge()
	if err != nil {
		return nil, err
	}
	instance, err := dunbox.New(dunbox.Options{Options: options})
	if err != nil {
...
func createDialer(instance *dunbox.Box, network string, outboundTag string) (N.Dialer, error) {
	if outboundTag == "" {
